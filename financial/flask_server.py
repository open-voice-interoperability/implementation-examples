#!/usr/bin/env python3
"""
Flask HTTP Server for Financial Agent
...
Configure host and port via environment variables:
    HOST=0.0.0.0 PORT=8083 python flask_server.py
...
if __name__ == '__main__':
    ...
    logger.info("=" * 60)
    logger.info("Financial Agent Server")
    logger.info("=" * 60)
    ...
    logger.info(f"  POST /manifest - Agent manifest")
    logger.info("=" * 60)
